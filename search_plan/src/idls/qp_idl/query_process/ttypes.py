...
class QPRequest(object):
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            ...
            return
        oprot.writeStructBegin('QPRequest')
...
class QPReturnInfo(object):
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('QPReturnInfo')
...
class QPReturnVector(object):
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('QPReturnVector')
...
class QPSearchResult(object):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRUCT:
                    self.ret_info = QPReturnInfo()
                    self.ret_info.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.STRUCT:
                    self.ret_vec = QPReturnVector()
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('QPSearchResult')
...
class QPRequestException(TException):
    """
    Attributes:
     - code
     - excp
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('QPRequestException')
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(QPRequest)
QPRequest.thrift_spec = (
    None,  # 0
...
all_structs.append(QPReturnInfo)
QPReturnInfo.thrift_spec = (
    None,  # 0
    (1, TType.I32, 'img_cnt', None, None, ),  # 1
    (2, TType.I32, 'img_dim', None, None, ),  # 2
    (3, TType.LIST, 'debug_info', (TType.STRING, 'UTF8', False), None, ),  # 3
)
all_structs.append(QPReturnVector)
QPReturnVector.thrift_spec = (
    None,  # 0
    (1, TType.LIST, 'list_image_vectors', (TType.LIST, (TType.DOUBLE, None, False), False), None, ),  # 1
)
all_structs.append(QPSearchResult)
QPSearchResult.thrift_spec = (
    None,  # 0
    (1, TType.I32, 'ret_status', None, None, ),  # 1
    (2, TType.STRUCT, 'ret_info', [QPReturnInfo, None], None, ),  # 2
    (3, TType.STRUCT, 'ret_vec', [QPReturnVector, None], None, ),  # 3
)
all_structs.append(QPRequestException)
QPRequestException.thrift_spec = (
    None,  # 0
